...
% FFt menu span=100 kHz, Linewidth=250 kHz , acq time=4ms
% FFt menu span=12.5 kHz, Linewidth=31.25 kHz , acq time=32ms
...
str = {'Span=100 kHz','Linewidth=250 kHz','Acq-time=4ms'};
...
str = {'Span=12.5 kHz','Linewidth=31.25 kHz','Acq-time=32ms'};
